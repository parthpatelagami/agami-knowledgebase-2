...
exports.createNewCategoryController = async (req, res) => {
    const { category_name, active, created_by } = req.body
...
exports.editCategoryController = async (req, res) => {
    ...
    try {
        ...
        const { category_name, active, modified_date, modified_by } = req.body
        ...
        existingCategory.modified_date = modified_date
